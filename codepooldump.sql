...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Stores users'
...
CREATE TABLE `PRODUCT` (
  ...
  `SELLER_ID` int(11) DEFAULT NULL COMMENT 'The ID of the seller - points to user table',
  PRIMARY KEY (`ID`),
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Stores products'